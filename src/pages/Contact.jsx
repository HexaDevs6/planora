                        ...
                        >
                           <Card className="h-full border-0 shadow-xl relative bg-violet-dark/20 backdrop-blur-2xl p-0 group">
                              ...
                              <CardContent className="p-6 text-center space-y-3">
                                 <div className="flex h-14 w-14 items-center justify-center rounded-full bg-gradient-amber text-violet mx-auto">
                           ...
                           <CardContent className="p-8 md:p-12">
                              ...
                              >
                                 ...
                                 <Button
                                    ...
                                    variant="hero"
                                    size="lg"
                                    className="w-full md:w-auto bg-gradient-amber"
                                 >
