...
// import img from "./asests/imgR.png";
// import img1 from "./asests/logo.png";
         ...
         <div className="w-full md:w-1/2 flex items-start justify-center px-8 md:px-20 py-12 md:py-16">
            <div className="w-full max-w-lg">
               <header className="mb-10">
                  ...
                  <h1 className="text-[31.25px] font-extrabold text-[#2b0a1c] leading-tight">
                     Where great events
                     <br />
                     begin.
                  </h1>
        ...
        peer-placeholder-shown:text-base peer-focus:top-2 peer-focus:text-sm peer-focus:text-amber"
                  ...
                  <div className="mt-6 text-center font-[12.8px] text-[#616161]">
                     <h5>
                        ...
                        <a
                           href="#"
                           className="text-violet text-decoration-line: underline; font-[900]"
                        >
                           Log in here
                        </a>
                     </h5>
         ...
         <div className="w-full md:w-1/2 flex items-center justify-center px-8">
            <div className="w-[420px] h-[600px] ">
               <img src={"https://placehold.co/400"} alt="Register" className="w-full  object-cover" />
