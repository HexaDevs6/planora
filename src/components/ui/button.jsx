...
const buttonVariants = cva(
  " cursor-pointer inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-sm text-sm font-medium transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        amber: "bg-amber text-violet-dark hover:bg-[#ffb936] shadow-sm hover:shadow-md",
        primary: "bg-primary text-background  hover:scale-105",
        glass: "bg-secondary/10 backdrop-blur-xs text-secondary border border-secondary/30 hover:bg-primary/40 dark:text-primary",
        default: "bg-primary text-primary-foreground hover:bg-primary/90",
        destructive:
          "bg-destructive text-white hover:bg-destructive/90 focus-visible:ring-destructive/20 dark:focus-visible:ring-destructive/40 dark:bg-destructive/60",
        outline:
          "border bg-background shadow-lg hover:bg-accent dark:bg-input/30 dark:border-input dark:hover:bg-input/70",
        secondary:
      ...
      size: {
        ...
        CTA: "h-10 rounded-md px-9 py-7 text-lg font-semibold [&_svg]:size-6 ",
        icon: "size-9",
        "icon-sm": "size-8",
        "icon-lg": "size-10",
      },
