  ...
  const handleCategories = [
    {
      ...
      title: "Concerts",
      description:
        "Get ready for electrifying nights filled with rhythm, passion, and crowd vibes that move your soul.",
      icon: (
        <Drum
          size={72}
          strokeWidth={1.7}
    ...
    },
    {
      ...
      title: "Wedding",
      description:
        "From charming halls to luxury setups — we make every wedding a dream come true with seamless planning and perfect details.",
      icon: (
        <Gem
          size={72}
          strokeWidth={1.7}
    ...
    },
    {
      ...
      title: "Theaters",
      description:
        "Discover world-class shows, breathtaking performances, and unforgettable nights at the finest theaters.",
      icon: (
        <Theater
          size={72}
          strokeWidth={1.7}
