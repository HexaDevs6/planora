...
export function PasswordStrengthMeter({
  ...
  const getSegmentColor = segmentStrength => {
    ...
    <div className={cn(appliedTheme.container, className)} {...props}>
      <div className={cn(appliedTheme.inputContainer)}>
        <Input
          ...
          placeholder={lang === "ar" ? "أدخل كلمة المرور" : placeholder} />
        <div
          ...
          {enableAutoGenerate && (
            <button
              ...
              aria-label={lang === "ar" ? "توليد كلمة مرور قوية" : "Generate strong password"}
              title={lang === "ar" ? "توليد كلمة مرور قوية" : "Generate strong password"}>
      ...
      {showText && password && (
        <div className="flex items-center">
          ...
          <span className="ml-auto text-xs text-muted-foreground">
            {lang === "ar" 
              ? `${getPassedRequirements().length} من ${requirements.length} من المتطلبات مستوفاة`
            ...
            <div
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm font-medium text-blue-800 dark:text-blue-200">
                  {lang === "ar" ? "توليد كلمة مرور قوية تلقائياً" : "Auto-generate strong password"}
                </span>
              </div>
              <button
                type="button"
            ...
            {requirements.map((requirement, index) => {
              ...
              return (
                <li key={index} className={cn(appliedTheme.requirementItem)}>
                  {passed ? (
                    <Check
                      className={cn(appliedTheme.requirementIcon, "text-emerald-500 dark:text-emerald-400")} />
                  ) : (
